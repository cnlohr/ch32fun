	/* /index.html */
	static const char name_index_html[] = {
...
__attribute__((aligned(4))) static const char data_index_html[] = {
	...
	0x6f, 0x20, 0x66, 0x72, 0x6f, 0x6d, 0x20, 0x61, 0x20, 0x63, 
	0x68, 0x33, 0x32, 0x66, 0x75, 0x6e, 0x20, 0x77, 0x65, 0x62, 
	0x20, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x21, 0x3c, 0x62, 
...
const struct fsdata_file file_index_html[] = {{NULL, name_index_html, data_index_html, sizeof(data_index_html)}};

const struct fsdata_file file_404_html[] = {{file_index_html, name_404_html, data_404_html, sizeof(data_404_html)}};
