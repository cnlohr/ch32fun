...
This may not be super accurate, so you might want to scan the whole stack and note
the lowest address that has been overwritten for a more accurate measurement.
