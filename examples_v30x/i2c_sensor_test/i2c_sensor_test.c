...
int main() {
	...
	if (I2C_TARGET == I2C1) {
		funPinMode(PB6, GPIO_CFGLR_OUT_50Mhz_AF_OD);	// I2C1 SCL
		funPinMode(PB7, GPIO_CFGLR_OUT_50Mhz_AF_OD);  	// I2C1 SDA		
	} else {
		funPinMode(PB10, GPIO_CFGLR_OUT_50Mhz_AF_OD);	// I2C1 SCL
		funPinMode(PB11, GPIO_CFGLR_OUT_50Mhz_AF_OD);  	// I2C1 SDA
	}
